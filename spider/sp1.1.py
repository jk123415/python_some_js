#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Date    : 2018-08-06 18:27:14
# @Author  : jk (you@example.org)
...
var = {
    ...
    'tag': {
        ...
        "借款期限": {
            ...
            # 1 default page code; 2 associated page 1 ; 3 associated page 2;...;0 sorce uri
            'dataSource': 1,
            'extractMethod': 'xpath', 'selector': '/html/body/div[2]/div/div[8]/div[2]/div[2]/div[3]/span',
            'dataHandle': {},
            'contentFilter': {
                'htmlTagClear': False,
                'noNone': True,
        ...
        "年利率": {
            ...
            # 1 default page code; 2 associated page 1 ; 3 associated page 2;...;0 sorce uri
            'dataSource': 1,
            'extractMethod': 'xpath', 'selector': '/html/body/div[2]/div/div[8]/div[2]/div[2]/div[1]/span/text()',
            'dataHandle': {},
            'contentFilter': {
                'htmlTagClear': True,
                'noNone': True,
        ...
        "还款方式": {
            ...
            # 1 default page code; 2 associated page 1 ; 3 associated page 2;...;0 sorce uri
            'dataSource': 1,
            'extractMethod': 'xpath', 'selector': '/html/body/div[2]/div/div[8]/div[2]/div[2]/div[3]/div/span[2]',
            'dataHandle': "",
            'contentFilter': {
                'htmlTagClear': True,
                'noNone': True,
